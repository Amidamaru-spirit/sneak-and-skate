    ...
    try {
      if (favorites.find((favObj) => Number(favObj.parentId) === Number(obj.id))) {
        ...
        const { data } = await axios.post(
          'https://640f562e4ed25579dc4c83f2.mockapi.io/favorites',
          obj,
        );
  ...
  return (
    <AppContext.Provider 
      ...
      <div className="wrapper clear">
          ...
          <Routes>     
            <Route path="sneak-and-skate" exact element={
              <Home 
                items={items}
                cartItems={cartItems}
              ...
              />} 
            />
            <Route path="sneak-and-skate/favorites" exact element={
              <Favorites />} 
            />
            <Route path="sneak-and-skate/orders" exact element={
              <Orders />} 
            />
          </Routes>
      </div>
